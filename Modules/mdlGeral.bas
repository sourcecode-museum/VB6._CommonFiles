...
'Fun��o para abreviar nomes Proprios
...
Public Function AbreviaNome(psNome As String, Optional TCase As VbStrConv = vbUpperCase)
  ...
  aNomes() = Split(psNome, " ") 'Array � de Base Zero
  ...
  If nCount > 1 Then
    ...
    For i = 1 To nCount - 1
      ...
      If Len(aNomes(i)) > 3 Then
        'Se n�o. Pega apenas a primeira letra do nome e coloca um ponto ap�s.
...
Public Function ValorData(ByVal pnData As geDataPadr�o, Optional ByVal pFormato As String = "dd/mm/yyyy") As String
   Dim sData As String
   ...
   Select Case pnData
      ...
      Case Else
         '� o pr�prio conte�do do campo
   End Select
   ValorData = sData
End Function

Public Function UltimoDiaDoMes(ByVal psData As String) As String
   Dim sM�s As String, sAno As String
   Dim sM�sAno As String
   
   sM�s = Format$(psData, "mm")
   ...
   Select Case sM�s
    ...
    Case Else
       ...
       End If
   End Select
   sM�sAno = Format$(psData, "mm/yyyy")
   UltimoDiaDoMes = UltimoDiaDoMes & "/" & sM�sAno
End Function
...
Public Function ExtractResData(sID As String, sType As String, PathArqDestino As String, Optional ByVal exitIfExist As Boolean = False) As Boolean
  ...
  If FileExist(PathArqDestino) Then
    ...
    If MsgBox("Arquivo j� existe!" & vbCrLf & vbCrLf & "Deseja substitui-l�?", _
...
Public Sub MGShowErro(ByVal pProcedure As String, Optional ByVal Mensagem As String, Optional ByVal Titulo As String)
  If Mensagem = "" Then
    Mensagem = "Procedimento..: " & pProcedure & vbCrLf & _
               "N�mero do Erro: " & Err.Source & vbCrLf & _
               "Descri��o.....: " & Err.Description & vbCrLf & vbCrLf & _
...
Public Function MGShowQuest(ByVal Mensagem As String, _
                            ...
                            Optional ByVal psBotoes As String = "&Sim|&N�o") As String
  If Titulo = "" Then
    Titulo = App.ProductName
    If Titulo = "" Then Titulo = App.EXEName
  End If
...
DeNovo:
  ...
  Next                                    'pr�ximo caracter a encriptar
...
Public Function CalculaIdade(ByVal XData) As String
  ...
  Else
    ...
    If Val(nMes) > 0 Then
      ...
      sIdade = sIdade & Val(nMes) & IIf(Val(nMes) = 1, " m�s", " meses")
    End If
